...
import net.preibisch.bigdistributor.algorithm.clustering.scripting.cluster.SGE.SGEClusterScript;
import net.preibisch.bigdistributor.algorithm.clustering.scripting.cluster.SGE.SGESubmitFile;
...
import net.preibisch.bigdistributor.io.GsonIO;
import net.preibisch.bigdistributor.io.TaskFile;
...
public class ClusterWorkflow {
	...
	private static final String TASK_PATH = "/fast/AG_Preibisch/Marwan/clustering/jars/FusionV3.jar";
